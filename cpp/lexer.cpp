...
lextokens lext()
{
    ...
    if (isalpha(ch))
    {
        ...
        {
            currenttoken = elseifsym;
        }
        else if (identifier == "else")
        {
            currenttoken = elsesym;
        }
        else if (identifier == "print")
        {
            currenttoken = printsym;
        }
        else if (identifier == "return")
        {
            currenttoken = returnsym;
        }
    ...
    case '-':
        ...
        break;
    case '*':
        currenttoken = multiplysym;
        ch = getch();
        break;
    case '(':
        currenttoken = openbracketsym;
        ch = getch();
        break;
    case ')':
        currenttoken = closebracketsym;
        ch = getch();
        break;
    case '[':
        currenttoken = opensquaresym;
        ch = getch();
        break;
    case ']':
        currenttoken = closesquaresym;
        ch = getch();
        break;
    case ' ':
        currenttoken = whitespacesym;
        ch = getch();
        break;
    case '!':
        ch = getch();
    ...
    case '>':
        ...
        if (ch == '=')
        {
            currenttoken = greaterorequalsym;
            ch = getch();
        }
        else
        {
            currenttoken = greaterthansym;
        };
        break;
    case '<':
        ch = getch();
        if (ch == '=')
        {
            currenttoken = lessorequalsym;
            ch = getch();
        }
        else
        {
            currenttoken = lessthansym;
        };
        break;
    case '=':
        ch = getch();
        if (ch == '=')
        {
            currenttoken = equalsym;
            ch = getch();
        }
        else
        {
            currenttoken = assignsym;
        };
        break;
    case '#':
        ch = getch();
        if (ch == '!')
        {
            currenttoken = shebangsym;
            ch = getch();
        }
        else
        {
            currenttoken = commentsym;
        };
        break;
    default:
        currenttoken = errorsym;
        cout << "Im the culprit " << ch << " tracker " << tracker << endl;
        identifier = "";
        identifier = identifier + ch;
        ch = getch();
        break;
...
lextokens lexer()
{
    ...
    if (tok == intsym)
        intvalue = stod(dat);
    if (tok == identifiersym || tok == singlequotesym || tok == doublequotesym)
        identifier = dat;
